...
<body class="bg-gray-100">
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
            <h1 class="text-xl font-bold mb-4">Text decryption</h1>
            <form action="{{ route('decrypt.text') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
                    <label for="decryptionKey" class="block text-sm font-medium text-gray-700">Decryption Key:</label>
                    <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm" id="decryptionKey" name="decryptionKey" required>
                </div>
                <div>
                    <label for="text" class="block text-sm font-medium text-gray-700">Text to decrypt:</label>
                ...
                <button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-800">decrypt</button>
