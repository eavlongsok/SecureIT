...
<body class="bg-gray-100">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
        <h1 class="text-2xl font-bold mb-4">Video Cryptography</h1>
        <div class="flex flex-col space-y-4">
        <a href="{{ route('video.encrypt.form') }}" class="bg-black text-white py-2 px-4 rounded-md shadow-md text-center hover:bg-gray-800 hover:text-white transition duration-300">Encryption</a>
        <a href="{{ route('video.decrypt.form') }}" class="bg-black text-white py-2 px-4 rounded-md shadow-md text-center hover:bg-gray-800 hover:text-white transition duration-300">Decryption</a>
