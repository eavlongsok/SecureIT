                    ...
                    <form method="post" action="/video/encrypt" enctype="multipart/form-data" id="form">
                        ...
                        <main class="flex-1 py-12 px-4 md:px-6 bg-gray-100">
                                    ...
                                    <div class="p-6">
                                        <div class="grid gap-4 md:grid-cols-1 lg:grid-cols-1">
                                            ...
                                            <div class="flex items-center gap-2 p-2 rounded transition-colors duration-200">
                                                ...
                                                <span class="text-lg">Input Absoulte Path For Your Video:</span>
                                                <input type="text" name="path" id="path" class="ml-auto w-[13rem] text-gray-800 font-semibold py-2 px-4 border-2 focus:outline-1 focus:outline-gray-300 overflow-clip" onkeyup="if(event.keyCode === 13) { submitForm(); }" placeholder="Enter absolute path here" required onkeyup="checkKeyLength()" />
                                            </div>
                                            <div class="flex items-center gap-2 p-2 rounded transition-colors duration-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-12 w-12">
                                                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                                                ...
                                                <input accept="video/mp4 video/webm video/x-matroska" type="file" name="video" id="video" required disabled onchange="submitForm()" class="ml-auto w-[13rem] text-gray-800 font-semibold py-2 overflow-clip" />
                                            </div>
                                            <div class="flex items-center gap-2 p-2 rounded transition-colors duration-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-12 w-12">
                            ...
                            <p class="font-bold text-2xl text-center mt-6 hidden" id="submitting">Submitting...
                                <div id="recorder-container" class="fixed hidden top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 justify-center items-center cursor-pointer" onclick="cancelRecordVideo()">
                                    <input accept="video/mp4 video/webm video/x-matroska" type="file" name="video" id="video" required disabled onchange="submitForm()" class="ml-auto w-[13rem] text-gray-800 font-semibold py-2 overflow-clip" />
                                </div>
                                <div class="flex items-center gap-2 p-2 rounded transition-colors duration-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-12 w-12">
        ...
        <div id="recorder-container" class="fixed hidden top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 justify-center items-center cursor-pointer" onclick="cancelRecordVideo()">
            ...
            <div id="recorder" class="w-5/6 h-5/6 bg-white z-[100] cursor-auto p-4" onclick="preventClickThrough(event)">
                ...
                <div class="flex justify-center gap-x-10 mt-6">
                    <button id="start" type="button" class="w-[10rem] py-4 px-2 bg-green-700 text-white text-lg font-semibold rounded-xl shadow select-none" onclick="startRecordingVideo()">
                        Start
                        Recording
                    </button>
                    ...
                    <button id="cancel-btn" class="w-[10rem] py-4 px-2 bg-red-700 text-white text-lg font-semibold rounded-xl shadow select-none" onclick="cancelRecordVideo()" type="button">Cancel
                    </button>
                </div>
            </div>
        </div>
