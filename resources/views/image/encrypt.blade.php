            ...
            <main class="flex-1 py-12 px-4 md:px-6 bg-gray-100">
                ...
                <p class="font-bold text-2xl text-center mt-6 hidden" id="submitting">Submitting...
                    <div id="recorder-container"
                        ...
                        <div id="recorder"
                            class="w-5/6 h-5/6 bg-white z-[100] cursor-auto p-4"
                            ...
                            <div class="flex justify-center gap-x-10 mt-6">
                                <button id="start" type="button"
                                    ...
                                    onclick="startRecordingImage()">
                                    Start Capture
                                </button>
                                <button type="button" id="stop"
                                    class="w-[10rem] py-4 px-2 bg-red-700 text-white text-lg font-semibold rounded-xl shadow hidden select-none">
                                    Stop Capture
                                </button>
                                <button id="recording-submit-btn"
                                ...
                                <button id="cancel-btn"
                                    class="w-[10rem] py-4 px-2 bg-gray-700 text-white text-lg font-semibold rounded-xl shadow select-none"
                                    onclick="cancelRecordImage()" type="button">
                                    Cancel
                                </button>
                            </div>
                        </div>
