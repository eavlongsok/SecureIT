        ...
        <form id="form" action="{{ route('image.result') }}" method="POST">
            ...
            <main class="flex-1 py-12 px-4 md:px-6 bg-gray-100">
                        ...
                        <div class="p-6">
                            <div class="grid gap-4 md:grid-cols-1 lg:grid-cols-1">
                                <div class="flex items-center gap-2 p-2 rounded transition-colors duration-200">
                                    ...
                                    <input type="text" name="key" maxlength="16" id="key" class="ml-auto w-[13rem] text-gray-800 font-semibold py-2 px-4 border-2 focus:outline-1 focus:outline-gray-300 overflow-clip" placeholder="Enter key here" required />
                                ...
                                <div class="flex items-center gap-2 p-2 rounded transition-colors duration-200">
                                    ...
                                    <button class="ml-auto bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow select-none" onclick="showTakeImage()" type="button">
                                        Capture
                                    </button>
                                </div>
                            </div>
                ...
                <p class="font-bold text-2xl text-center mt-6 hidden" id="submitting">Submitting...
                    <div id="recorder-container" class="fixed hidden top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 justify-center items-center cursor-pointer" onclick="cancelTakeImage()">
