		...
		<div class="max-w-6xl mx-auto grid gap-10 md:grid-cols-1">
			<div class="rounded-lg border bg-card text-card-foreground shadow-xl" data-v0-t="card">
				<div class="flex flex-col space-y-1.5 p-6">
					<h3 class="font-semibold tracking-tight text-xl">Cryptography  Services</h3>
					<p class="text-sm text-muted-foreground">
						Our cryptography  services allow you to secure your data in various formats. Choose the type of
						data you wish to encrypt/decrypt from the options below.
					</p>
				</div>
				<div class="p-6">
					<div class="grid gap-4 md:grid-cols-1 lg:grid-cols-1">
						...
						>
							...
							<span>Text Cryptography : Secure your written documents and messages.</span>
						</a>
						<a
							class="flex items-center gap-2 hover:bg-gray-200 p-2 rounded transition-colors duration-200"
							href="{{ route('audio.view') }}"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="24"
							...
							<span>Audio Cryptography : Protect your audio files and conversations.</span>
						</a>
						<a
							class="flex items-center gap-2 hover:bg-gray-200 p-2 rounded transition-colors duration-200"
						...
						>
							...
							<span>Image Cryptography : Safeguard your images and visual data.</span>
						</a>
						<a
							class="flex items-center gap-2 hover:bg-gray-200 p-2 rounded transition-colors duration-200"
							href="{{ route('video.view') }}"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="24"
							...
							<span>Video Cryptography : Secure your video file and footage.</span>
						</a>
					</div>
				</div>
			</div>
